    ...
    <footer className="bg-[#111111] border-t border-[#0A0A0A]">
      <div className="container mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-[#F8FAFC]/70 mb-4">
                Lüks gayrimenkul danışmanlığı hizmetleri ile hayalinizdeki yaşam
                alanını bulmanıza yardımcı oluyorum.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center gap-2 text-[#F8FAFC]/70 hover:text-[#CFA670] transition-colors"
                >
                  <Phone size={18} />
                ...
                <div className="flex items-start gap-2 text-[#F8FAFC]/70">
                  ...
                  <span>
                    Acıbadem, 218/A Alparslan iş merkezi, 34660<br></br>{" "}
                    Üsküdar/İstanbul
                  </span>
                </div>
              </div>
        ...
        <div className="border-t border-[#0A0A0A] mt-8 pt-8 text-center text-[#F8FAFC]/50 text-sm">
          <p>
            &copy; {new Date().getFullYear()} Yusuf Ali Soykan. Tüm hakları
            saklıdır.
          </p>
          <p className="text-[12px] py-1">
            Powered by{" "}
            <a href="https://www.mfdigitalstudio.com" target="_blank">
              <b>MF Digital Studio</b>
            </a>
          </p>
        </div>
      </div>
